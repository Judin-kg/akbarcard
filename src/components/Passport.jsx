...
// N:Rahim;Ajmal;;;
// FN:Ajmal Rahim
// ORG:AKBAR TRAVELS;MARIHA TOURS & TRAVELS
// TITLE:Franchise of Akbar Travels
...
//             <path
//               d="M20.5 11.7c0 4.9-4 8.8-8.8 8.8-1.6 0-3.1-.4-4.3-1.1L3.5 21l1.7-3.7a8.7 8.7 0 0 1-1.3-4.6c0-4.9 4-8.8 8.8-8.8s8.8 4 8.8 8.8Z"
//               stroke="#25D366"
//               strokeWidth="1.6"
//             />
//             <path
//               d="M9.6 7.9c-.2-.5-.4-.5-.6-.5H8.4c-.2 0-.5.1-.7.3-.2.2-.9.9-.9 2.3s.9 2.7 1 2.9 1.8 2.8 4.3 3.8c2.1.8 2.6.7 3 .7.4 0 1.5-.6 1.7-1.2.2-.6.2-1.1.2-1.2 0-.1-.1-.2-.3-.3l-1.6-.7c-.2-.1-.3 0-.4.1l-.6.8c-.1.2-.3.2-.5.1-.2-.1-.9-.3-1.7-1-.6-.5-1-1.1-1.2-1.2-.1-.2 0-.3.1-.4l.3-.3c.2-.2.2-.3.3-.5 0-.2 0-.4 0-.5s-.5-1.4-.7-1.9z"
//               fill="#25D366"
//             />
//           </svg>
//         </a>
...
//             <path
//               d="M12 3v14m0 0 4-4m-4 4-4-4M4 21h16"
//               stroke="#ffffff"
//               strokeWidth="1.6"
//               strokeLinecap="round"
...
//         >
//           <svg className="at-icon" viewBox="0 0 24 24" fill="none">
//             <circle cx="12" cy="12" r="9" stroke="#e5e7eb" strokeWidth="1.6" />
//             <path
//               d="M3 12h18M12 3c3 3.5 3 14 0 18M8 3c2 3.5 2 14 0 18M16 3c-2 3.5-2 14 0 18"
//               stroke="#e5e7eb"
//               strokeWidth="1.2"
//             />
//           </svg>
...
//           <svg className="at-smallIcon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
//             <path
//               d="M22 16.9v2a2 2 0 0 1-2.2 2 19.9 19.9 0 0 1-8.7-3.1 19.6 19.6 0 0 1-6-6A19.9 19.9 0 0 1 2.9 3.8 2 2 0 0 1 4.9 2h2a2 2 0 0 1 2 1.7c.1.9.4 1.8.7 2.7a2 2 0 0 1-.5 2.1L8.2 9.4a16 16 0 0 0 6 6l1.8-1c.6-.3 1.4-.2 2 .2.9.3 1.8.6 2.7.7A2 2 0 0 1 22 16.9Z"
//               stroke="#9ca3af"
//               strokeWidth="1.4"
//             />
//           </svg>
//           <a href={`tel:${phoneE164}`}>{phoneHuman}</a>
//         </div>
...
//         <span>Share your contact with a tap</span>
...
export default function AkbarTravelsCard() {
  ...
  return (
    ...
    >
      ...
      <p className="at-tagline">FROM DREAMS TO DESTINATION akbarrrrrr</p>
